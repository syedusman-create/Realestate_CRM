    ...
    >
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Update physical inventory and pricing information.
        </p>
      </div>
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        ...
        <label className="space-y-1.5 text-sm">
          ...
          <select
            ...
            defaultValue={unit.configuration_id ?? ''}
            className="h-9 w-full rounded-md border bg-background px-3"
          >
        ...
        <label className="space-y-1.5 text-sm">
          ...
          <input
            name="parking_count"
            type="number"
            defaultValue={unit.parking_count ?? ''}
            className="h-9 w-full rounded-md border bg-background px-3"
          />
        </label>
        ...
        <label className="space-y-1.5 text-sm">
          ...
          <input
            ...
            type="number"
            step="0.01"
            defaultValue={unit.carpet_area_sqft ?? ''}
            className="h-9 w-full rounded-md border bg-background px-3"
          />
        </label>
        ...
        <label className="space-y-1.5 text-sm">
          ...
          <input
            ...
            type="number"
            step="0.01"
            defaultValue={unit.builtup_area_sqft ?? ''}
            className="h-9 w-full rounded-md border bg-background px-3"
          />
        </label>
        ...
        <label className="space-y-1.5 text-sm">
          ...
          <input
            ...
            type="number"
            step="0.01"
            defaultValue={unit.super_builtup_area_sqft ?? ''}
            className="h-9 w-full rounded-md border bg-background px-3"
          />
        </label>
        ...
        <label className="space-y-1.5 text-sm">
          ...
          <input
            ...
            type="number"
            step="0.01"
            defaultValue={unit.balcony_area_sqft ?? ''}
            className="h-9 w-full rounded-md border bg-background px-3"
          />
        </label>
        ...
        <label className="space-y-1.5 text-sm">
          ...
          <input
            ...
            type="number"
            step="0.01"
            defaultValue={unit.asking_price ?? ''}
            className="h-9 w-full rounded-md border bg-background px-3"
          />
        </label>
        ...
        <label className="space-y-1.5 text-sm">
          ...
          <input
            ...
            type="number"
            step="0.01"
            defaultValue={unit.price_per_sqft ?? ''}
            className="h-9 w-full rounded-md border bg-background px-3"
          />
        </label>
      </div>
