...
export interface LeadAssignmentRow { id: string; lead_id: string; assigned_to: string; assigned_by: string | null; assignment_type: string; started_at: string; ended_at: string | null; reason: string | null; created_at: string }
export interface RequirementRow { id: string; lead_id: string; requirement_type: RequirementType; purpose: PurposeType | null; budget_min: number | null; budget_max: number | null; bedrooms_min: number | null; bedrooms_max: number | null; bathrooms_min: number | null; area_min_sqft: number | null; area_max_sqft: number | null; furnishing: Furnishing | null; possession_before: string | null; preferred_floor_min: number | null; preferred_floor_max: number | null; preferred_facing: string | null; parking_required: number | null; notes: string | null; is_active: boolean; created_at: string; updated_at: string }
export interface PipelineRow { id: string; workspace_id: string | null; tenant_code: string | null; name: string; is_default: boolean | null; created_at: string | null }
export interface PipelineStageRow { id: string; pipeline_id: string; name: string; stage_type: DealStageType; display_order: number; win_probability: number | null; created_at: string | null }
...
export interface LeadDashboardRow { lead_id: string; person_id: string; person_name: string; phone: string | null; email: string | null; assigned_user_id: string | null; assigned_user_name: string | null; pipeline_name: string | null; stage_name: string | null; priority: LeadPriority | null; temperature: LeadTemperature | null; lead_score: number | null; first_contact_at: string | null; last_contact_at: string | null; next_followup_at: string | null; closed_at: string | null; next_task_due_at: string | null; call_count: number | null; created_at: string | null; updated_at: string | null; tenant_id: string | null; workspace_id: string | null }
...
export interface Database {
  public: {
    Tables: {
      ...
      lead_assignments: { Row: LeadAssignmentRow; Insert: Partial<LeadAssignmentRow> & Pick<LeadAssignmentRow, 'lead_id' | 'assigned_to' | 'assignment_type' | 'started_at'>; Update: Partial<LeadAssignmentRow>; Relationships: [] }
      requirements: { Row: RequirementRow; Insert: Partial<RequirementRow> & Pick<RequirementRow, 'lead_id' | 'requirement_type'>; Update: Partial<RequirementRow>; Relationships: [] }
      pipelines: { Row: PipelineRow; Insert: Partial<PipelineRow> & Pick<PipelineRow, 'name'>; Update: Partial<PipelineRow>; Relationships: [] }
      pipeline_stages: { Row: PipelineStageRow; Insert: Partial<PipelineStageRow> & Pick<PipelineStageRow, 'pipeline_id' | 'name' | 'stage_type' | 'display_order'>; Update: Partial<PipelineStageRow>; Relationships: [] }
